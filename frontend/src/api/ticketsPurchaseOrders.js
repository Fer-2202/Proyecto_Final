...
export const getTicketsPurchaseOrderById = async (id) => {
  try {
    const response = await axiosInstance.get(`/api/tickets_purchase_orders/${id}/`);
    return response.data;
  } catch (error) {
    console.error(`Error fetching tickets-purchase order with ID ${id}:`, error);
    throw error;
  }
};
...
export const createTicketsPurchaseOrder = async (data) => {
  try {
    const response = await axiosInstance.post('/api/tickets_purchase_orders/', data);
    return response.data;
  } catch (error) {
...
export const updateTicketsPurchaseOrder = async (id, data) => {
  try {
    const response = await axiosInstance.put(`/api/tickets_purchase_orders/${id}/`, data);
    return response.data;
  } catch (error) {
    console.error(`Error updating tickets-purchase order with ID ${id}:`, error);
    throw error;
  }
};
...
export const deleteTicketsPurchaseOrder = async (id) => {
  try {
    ...
    console.error(`Error deleting tickets-purchase order with ID ${id}:`, error);
    throw error;
  }
};
