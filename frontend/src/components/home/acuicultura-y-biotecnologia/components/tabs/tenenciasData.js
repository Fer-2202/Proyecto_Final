...
export const tenencias = [
  {
    titulo: "Tenencia Responsable 1",
    descripcion: "En Costa Rica tenemos ocho especies de tortugas continentales las cuales son consideradas animales silvestres, por tanto no pueden ser mantenidas como mascotas ya que lo prohíbe la Ley de Conservación de Vida Silvestre.",
    img: placeholder,
  },
  {
    titulo: "Tenencia Responsable 2",
    descripcion: "En Costa Rica, la Ley de Conservación de Vida Silvestre prohíbe la tenencia de animales silvestres, esto porque en cautiverio muchas veces es difícil recrear el ambiente y alimentación natural que tienen estos organismos.",
    img: placeholder,
  },
  {
